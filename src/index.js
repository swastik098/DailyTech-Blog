    ...
    return (
      <Router>
        <Helmet>
          ...
          />
          <meta content="https://ibb.co/qRrnbqP" property="og:image" />
          <meta
            content="https://swastikgiri.vercel.app/"
            property="og:author"
          />
          ...
          />
          <meta content="https://ibb.co/qRrnbqP" name="facebook:image" />
          ...
          <link href="https://ibb.co/qRrnbqP" rel="icon" type="image/x-icon" />
          <meta content="@hockeycomp" name="twitter:site" />
          <meta content="https://ibb.co/qRrnbqP" name="twitter:image" />
          <meta
            content="a new modern web blog template cute blog for react with helmet SEO"
            name="twitter:description"
          />
          <link rel="apple-touch-icon" href="https://ibb.co/qRrnbqP" />
